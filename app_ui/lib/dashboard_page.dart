  ...
  Future<void> _fetchDashboardData() async {
    try {
      ...
      if (summaryRes.statusCode == 200 &&
          trendRes.statusCode == 200 &&
          distRes.statusCode == 200) {
        setState(() {
                ...
                children: [
                  Expanded(
                    child: _buildSummaryCard(
                      '累计报销总额',
                      '¥${_summary['total_amount'].toStringAsFixed(2)}',
                      Colors.blueAccent,
                    ),
                  ),
                  ...
                  Expanded(
                    child: _buildSummaryCard(
                      '待开票/处理中',
                      '¥${_summary['pending_amount'].toStringAsFixed(2)}',
                      Colors.orangeAccent,
                    ),
                  ),
                  const SizedBox(width: 16),
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (double value, TitleMeta meta) {
                ...
                String monthStr =
                    '${_trend[value.toInt()]['month'].toString().substring(5)}月';
                return Padding(
